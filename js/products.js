...
(function () {
  ...
  var PRODUCTS = [
    ...
    { cat: "leather", name: "Cow Wet Blue Leather", hs: "4107 91", img: "assets/products/leather/cow-wet-blue-leather.jpg", desc: "Chrome-tanned cow wet blue, strong and thick, ready for dyeing and finishing." },
    { cat: "leather", name: "Buffalo Wet Blue Leather", hs: "4107 91", img: "assets/products/leather/buffalo-wet-blue-leather.webp", desc: "Robust buffalo wet blue with heavy substance for footwear and upholstery." },
    { cat: "leather", name: "Goat Wet Blue Leather", hs: "4107 91", img: "assets/products/leather/goat-wet-blue-leather.jpeg", desc: "Fine-grain, soft goat wet blue, a base for garment and lining leather." },
    { cat: "leather", name: "Sheep Wet Blue Leather", hs: "4107 91", img: "assets/products/leather/sheep-wet-blue-leather.jpg", desc: "Supple, lightweight sheep wet blue for apparel and accessories." },

    /* ---- PRECIOUS STONES: placeholder imagery pending final photography ---- */
    { cat: "stones", name: "Garnet", hs: "7103 99", img: "assets/products/stones/garnet.jpg", desc: "Rough and faceted garnet in deep red and natural tones for jewellery and industrial use." },
    { cat: "stones", name: "Tourmaline", hs: "7103 99", img: "assets/products/stones/tourmaline.jpg", desc: "Multi-colour tourmaline, rough and cut, graded for clarity and hue." },
    { cat: "stones", name: "Amethyst", hs: "7103 99", img: "assets/products/stones/amethyst.jpg", desc: "Violet quartz amethyst, in rough, geode and faceted forms." },
    { cat: "stones", name: "Ruby", hs: "7103 91", img: "assets/products/stones/ruby.png", desc: "Natural ruby, rough and cut, graded by colour, clarity and origin." }
  ];
  ...
  function renderMatrix(host) {
    ...
    var filters = [
      ...
      { key: "stones", label: "Precious Stones" }
    ];
    ...
    function paint(key) {
      ...
      if (limit > 0) {
        ...
        if (key === "all") {
          var byCat = { agriculture: [], timber: [], leather: [], stones: [] };
          PRODUCTS.forEach(function (p) { byCat[p.cat].push(p); });
          var order = ["agriculture", "timber", "leather", "stones"], spread = [], row = 0;
